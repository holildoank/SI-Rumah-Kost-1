                            ...
                            <td>  
                                <table> 
                                    <tr>                                             
                                            ...
                                            $offset = $page * $entries;
                                            $result = mysql_db_query($db, "select * from rumah_kost where jenis_kost='perempuan'order by Nama_kost asc limit $offset,$entries", $koneksi); //output
                                        ...
                                        <tr>
                                            ...
                                            <td width="20%" bgcolor="#D3D3D3">Kouta</td>
