                    ...
                    <div main class="container clear"> 
                        ...
                        <div id="content" class="three_quarter first"> 
                            ...
                            <li class="clear">
                                ...
                                ?>
                                <div align="center"><font size="3" color="Black"><? echo $_GET['status'] ?></font></div>
                                <br />
                                <table>
                                    <tr> 
                                        ...
                                        <td>  
                                            <table> 
                                                <tr>                                             
                                                    ...
                                                    $offset = $page * $entries;
                                                    $result = mysql_db_query($db, "select * from rumah_kost where kategori='Rumah Kost' order by Nama_kost asc limit $offset,$entries", $koneksi); //output
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td width="25%" bgcolor="#D3D3D3">Alamat</td>
                                                        <td width="9%" bgcolor="#D3D3D3">Jumlah kamar </td>
                                                        <td width="25%" bgcolor="#D3D3D3">Kouta</td>
                                                        <td width="13%" bgcolor="#D3D3D3">Min HARGA</td>

                                                        <td width="17%" colspan="2" bgcolor="#D3D3D3">AKSI  </td>
                                                    </tr>
                                                   <?
...
//                                                    $pic = substr($gambar, 15, 40);
                                ...
                                <!--                                                    <img src="./admin/gambar/
                                                        ...
                                                        <td align="left"><? echo $row['alamat_kost']; ?></td>
                                                        <td color="black"><?php echo $jml_kmr; ?></td>
                                                          <td align="center"><?php echo $totalkouta; ?>&nbsp; Orang</td>
                                                        ...
                                                        <td colspan="2" align="center">
                                                            ...
                                                            <button type="button" class="btn-info"> <a  href="#" title="Klik untuk melihat kamar" onClick="konfirm(<? echo $id_rumah; ?>,<? echo $id_member; ?>)">PILIH</a></button>
                                                        </td>
                                            </tr>
                                            <?
                                        }
