...
class Calendar
{
    ...
    */
    ...
    /*
        ...
        represents Sunday.
    */
    var $dayNames = array("M", "S", "Sl", "R", "K", "J", "S");
    
    /*
        The labels to display for the months of the year. The first entry in this array
        represents January.
    */
    var $monthNames = array("Januari", "Februari", "Maret", "April", "Mai", "Juni",
...
<html>
<head><title>Membuat Kalender Sederhana</title></head>
<body>
<table width="17%" height="132" border="0" align="center" cellpadding="0" cellspacing="0" bordercolor="#99CC99">
<tr> 
	<td width="4%" align="right"><img src=""></td>
	<td width="50%" bgcolor="#333333" ><div align="center"><strong><font face="verdana" size="2" color="#FFFFFF">KALENDER</font></strong></div></td>
	<td width="21%"><img src=""></td>
</tr>
<tr>
	<td style="color:#000000" background="">&nbsp; </td>
	<td>
	<table width="186" align="center">
		...
		<table align="center">
		<tr>
			<td style="color:#000000" align="center"><b><? echo date("d"); ?></b></td>
		</tr>
		<tr>
			<td style="color:#000000" ><? echo $cal->getCurrentMonthView(); ?></td>
		</tr>
