...
// query database
$SQL = mysql_query("SELECT * FROM tabel_siswa where level='Pindah' or level='do'");
...
$objPHPExcel->getActiveSheet()->setCellValue('D2', "DAFTAR DATA SISWA TIDAK AKTIF");
...
header('Content-Disposition: attachment;filename="DATA_Siswa_Tidak_Aktif"'.date("d-F-Y").'".xlsx"');
