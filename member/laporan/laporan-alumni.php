...
// query database
$SQL = mysql_query("SELECT * FROM tabel_siswa where level='Alumni'");
...
$objPHPExcel->getActiveSheet()->setCellValue('D2', "DAFTAR DATA AlUMNI");
...
header('Content-Disposition: attachment;filename="DATA_Alumni"'.date("d-F-Y").'".xlsx"');
